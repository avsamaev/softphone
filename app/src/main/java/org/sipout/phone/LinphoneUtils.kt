...
import org.sipout.phone.contacts.getListOfSipAddresses
import org.sipout.phone.core.Account
import org.sipout.phone.core.Address
import org.sipout.phone.core.Call
import org.sipout.phone.core.Call.Dir
import org.sipout.phone.core.Call.Status
...
import org.sipout.phone.core.ConferenceScheduler
...
class LinphoneUtils {
    companion object {
        ...
        @AnyThread
        @DrawableRes
        fun getChatIconResId(chatState: ChatMessageState): Int {
            return when (chatState) {
                ChatMessageState.Displayed, ChatMessageState.FileTransferDone -> {
                    R.drawable.checks
                }
                ChatMessageState.DeliveredToUser -> {
                    R.drawable.check
                }
                ChatMessageState.Delivered -> {
                    R.drawable.envelope_simple
                }
                ChatMessageState.NotDelivered, ChatMessageState.FileTransferError -> {
                    R.drawable.warning_circle
                }
                ChatMessageState.InProgress, ChatMessageState.FileTransferInProgress -> {
                    R.drawable.animated_in_progress
                }
                ChatMessageState.PendingDelivery -> {
