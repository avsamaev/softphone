 ...
 */
package org.sipout.phone.ui.main.chat.fragment
...
import org.sipout.phone.compatibility.Compatibility
import org.sipout.phone.core.tools.Log
import org.sipout.phone.databinding.ChatConversationFragmentBinding
import org.sipout.phone.databinding.ChatConversationPopupMenuBinding
import org.sipout.phone.ui.GenericActivity
import org.sipout.phone.ui.main.chat.ConversationScrollListener
import org.sipout.phone.ui.main.chat.adapter.ConversationEventAdapter
import org.sipout.phone.ui.main.chat.adapter.MessageBottomSheetAdapter
import org.sipout.phone.ui.main.chat.model.FileModel
import org.sipout.phone.ui.main.chat.model.MessageDeliveryModel
import org.sipout.phone.ui.main.chat.model.MessageModel
import org.sipout.phone.ui.main.chat.model.MessageReactionsModel
import org.sipout.phone.ui.main.chat.view.RichEditText
import org.sipout.phone.ui.main.chat.viewmodel.ChatMessageLongPressViewModel
import org.sipout.phone.ui.main.chat.viewmodel.ConversationViewModel
import org.sipout.phone.ui.main.chat.viewmodel.SendMessageInConversationViewModel
import org.sipout.phone.ui.main.fragment.SlidingPaneChildFragment
import org.sipout.phone.utils.ConfirmationDialogModel
import org.sipout.phone.utils.DialogUtils
import org.sipout.phone.utils.Event
import org.sipout.phone.utils.FileUtils
import org.sipout.phone.utils.RecyclerViewHeaderDecoration
import org.sipout.phone.utils.RecyclerViewSwipeUtils
import org.sipout.phone.utils.RecyclerViewSwipeUtilsCallback
import org.sipout.phone.utils.TimestampUtils
import org.sipout.phone.utils.addCharacterAtPosition
import org.sipout.phone.utils.hideKeyboard
import org.sipout.phone.utils.setKeyboardInsetListener
import org.sipout.phone.utils.showKeyboard
    ...
    private fun displayDeliveryStatuses(model: MessageDeliveryModel) {
        ...
        tabs.addTab(
            tabs.newTab().setText(model.readLabel.value).setId(
                ChatMessageState.Displayed.toInt()
            )
        )
        tabs.addTab(
            tabs.newTab().setText(
                ...
                ChatMessageState.DeliveredToUser.toInt()
            )
        )
        tabs.addTab(
            tabs.newTab().setText(model.sentLabel.value).setId(
                ChatMessageState.Delivered.toInt()
            )
        )
        tabs.addTab(
            tabs.newTab().setText(
                ...
                ChatMessageState.NotDelivered.toInt()
            )
        )

        tabs.setOnTabSelectedListener(object : OnTabSelectedListener {
            override fun onTabSelected(tab: TabLayout.Tab?) {
                val state = tab?.id ?: ChatMessageState.Displayed.toInt()
                bottomSheetAdapter.submitList(
                    model.computeListForState(ChatMessageState.fromInt(state))
                )
            }
