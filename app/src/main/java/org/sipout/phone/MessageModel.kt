...
import org.sipout.phone.core.ConferenceInfo
import org.sipout.phone.core.Content
import org.sipout.phone.core.Factory
import org.sipout.phone.core.Player
import org.sipout.phone.core.PlayerListener
...
import org.sipout.phone.utils.AudioUtils
import org.sipout.phone.utils.Event
import org.sipout.phone.utils.FileUtils
import org.sipout.phone.utils.LinphoneUtils
import org.sipout.phone.utils.PatternClickableSpan
import org.sipout.phone.utils.SpannableClickedListener
...
class MessageModel
    ...
    private val chatMessageListener = object : ChatMessageListenerStub() {
        @WorkerThread
        override fun onMsgStateChanged(message: ChatMessage, messageState: ChatMessageState?) {
            if (messageState != ChatMessageState.FileTransferDone && messageState != ChatMessageState.FileTransferInProgress) {
                statusIcon.postValue(LinphoneUtils.getChatIconResId(ChatMessageState))

                if (messageState == ChatMessageState.Displayed) {
                    isRead = chatMessage.isRead
                }
            } else if (messageState == ChatMessageState.FileTransferDone) {
            ...
            isInError.postValue(messageState == ChatMessageState.NotDelivered)
        }
    ...
    init {
        ...
        isInError.postValue(ChatMessageState == ChatMessageState.NotDelivered)
