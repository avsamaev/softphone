...
import org.sipout.phone.BuildConfig
...
import org.sipout.phone.contacts.ContactsManager
import org.sipout.phone.core.tools.Log
import org.sipout.phone.notifications.NotificationsManager
import org.sipout.phone.telecom.TelecomManager
import org.sipout.phone.ui.call.CallActivity
import org.sipout.phone.utils.ActivityMonitor
...
class CoreContext
    ...
    val sdkVersion: String by lazy {
        ...
        val sdkBuildType = org.sipout.phone.core.BuildConfig.BUILD_TYPE
    ...
    private val coreListener = object : CoreListenerStub() {
        ...
        override fun onConfiguringStatus(
            ...
            if (status == ConfiguringState.Successful) {
                ...
                showGreenToastEvent.postValue(
                    Event(
                        Pair(
                            org.sipout.phone.R.string.remote_provisioning_config_applied_toast,
                            org.sipout.phone.R.drawable.smiley
                        )
                    )
                )
                ...
                showRedToastEvent.postValue(
                    Event(
                        Pair(
                            org.sipout.phone.R.string.remote_provisioning_config_failed_toast,
                            org.sipout.phone.R.drawable.warning_circle
                        )
                    )
                )
            }
            ...
            when (currentState) {
                ...
                Call.State.Error -> {
                    ...
                    showFormattedRedToastEvent.postValue(
                        Event(Pair(text, org.sipout.phone.R.drawable.warning_circle))
                    )
                }
                else -> {
                }
        ...
        override fun onTransferStateChanged(core: Core, transfered: Call, state: Call.State) {
            ...
            if (state == Call.State.Connected) {
                val icon = org.sipout.phone.R.drawable.phone_transfer
                showGreenToastEvent.postValue(
                    Event(Pair(org.sipout.phone.R.string.call_transfer_successful_toast, icon))
                )
            }
        }
    ...
    override fun run() {
        ...
        val gitVersion = AppUtils.getString(org.sipout.phone.R.string.linphone_app_version)
        val gitBranch = AppUtils.getString(org.sipout.phone.R.string.linphone_app_branch)
    ...
    fun computeUserAgent() {
        ...
        val appName = context.getString(org.sipout.phone.R.string.app_name)
