 ...
 */
package org.sipout.phone.notifications
...
import org.sipout.phone.contacts.AvatarGenerator
import org.sipout.phone.contacts.ContactsManager.ContactsListener
import org.sipout.phone.contacts.getAvatarBitmap
import org.sipout.phone.contacts.getPerson
import org.sipout.phone.core.Address
import org.sipout.phone.core.Call
import org.sipout.phone.core.ChatMessage
import org.sipout.phone.core.ChatMessageListener
import org.sipout.phone.core.ChatMessageListenerStub
import org.sipout.phone.core.ChatMessageReaction
import org.sipout.phone.core.ChatRoom
import org.sipout.phone.core.ConferenceParams
import org.sipout.phone.core.Core
import org.sipout.phone.core.CoreInCallService
import org.sipout.phone.core.CoreKeepAliveThirdPartyAccountsService
import org.sipout.phone.core.CoreListenerStub
import org.sipout.phone.core.Factory
import org.sipout.phone.core.Friend
import org.sipout.phone.core.MediaDirection
import org.sipout.phone.core.tools.Log
import org.sipout.phone.ui.call.CallActivity
import org.sipout.phone.ui.main.MainActivity
import org.sipout.phone.ui.main.MainActivity.Companion.ARGUMENTS_CHAT
import org.sipout.phone.ui.main.MainActivity.Companion.ARGUMENTS_CONVERSATION_ID
import org.sipout.phone.utils.AppUtils
import org.sipout.phone.utils.FileUtils
import org.sipout.phone.utils.LinphoneUtils
import org.sipout.phone.utils.ShortcutUtils
...
class NotificationsManager
    ...
    companion object {
        ...
        const val INTENT_HANGUP_CALL_NOTIF_ACTION = "org.sipout.phone.HANGUP_CALL_ACTION"
        const val INTENT_ANSWER_CALL_NOTIF_ACTION = "org.sipout.phone.ANSWER_CALL_ACTION"
        const val INTENT_REPLY_MESSAGE_NOTIF_ACTION = "org.sipout.phone.REPLY_ACTION"
        const val INTENT_MARK_MESSAGE_AS_READ_NOTIF_ACTION = "org.sipout.phone.MARK_AS_READ_ACTION"
    ...
    val chatMessageListener: ChatMessageListener = object : ChatMessageListenerStub() {
        @WorkerThread
        override fun onMsgStateChanged(message: ChatMessage, state: ChatMessageState) {
            ...
            if (state == ChatMessageState.Delivered || state == ChatMessageState.Displayed) {
